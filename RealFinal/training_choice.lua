...
function scene:create( event )
	...
	--수련 배경이미지 넣기
	local bg = display.newImage("image/training/수련_배경.png")
	...
	--warning text
	local warning = display.newImage("image/training/냥이부족합니다.png")
	...
	--수련 배경이미지 + 이벤트리스너
	for i = 1, 4 do
		training[i] = display.newImage("image/training/선택_"..i..".png")
	...
	local backButton = display.newImage("image/training/수련_돌아가기.png")
